...
int main() {
	...
	while(1) {
		...
		if(usb.ep_ready(1)) {
			...
			ana1_responsive.update((int) qe1_count);
			ana2_responsive.update((int) qe2_count);
			...
			input_report_t report = {1, buttons, uint8_t(ana1_responsive.getValue()), uint8_t(ana2_responsive.getValue())};
